...
# Function to load node metrics from the CSV file without using pandas
...
if __name__ == "__main__":
    ...
    # Load metrics from the CSV file without pandas
    metrics = load_node_metrics('/path/to/data.csv')
